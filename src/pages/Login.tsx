            ...
            <div className="login-container">
                ...
                <form autoComplete='on' onSubmit={handleLogin}>
                    <div className="form-group">
                        <input type="text" id="docId" name="docId" placeholder="Digite seu CPF" required value={docId} onChange={handleEmailChange} />
                    </div>
                    <div className="form-group" style={{ alignItems: "center" }}>
                        <input type={passVisible ? "text" : "password"} id="password" name="password" placeholder="Digite sua senha" required value={password} onChange={handlePasswordChange} />
