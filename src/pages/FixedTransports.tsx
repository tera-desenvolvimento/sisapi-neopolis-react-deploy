                ...
                <div className="menu-container">
                    <div className="logo-wrapper">
                        ...
                        <button onClick={toggleMenu} className="menu-button">
                            <svg width="20" viewBox="0 0 28 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 1.75H26" stroke="white" stroke-width="3" stroke-linecap="round"/>
                                <path d="M2 7.75H26" stroke="white" stroke-width="3" stroke-linecap="round"/>
                                <path d="M2 14.75H26" stroke="white" stroke-width="3" stroke-linecap="round"/>
                            </svg>
                        </button>
                    </div>
...

                {
                    transports.length <= 0 ? (
                        ...
                        <div className="transports-container" id="transports-container">
                            <div className="transports-swiper list">
                                {
                                    transports.map((transport, index) => (
                                        <div className={`transport-element fixed active`} id={`transport-${index}`} data-index={index} data-transport-id={transport._id} key={transport._id}>
                                                ...
                                                <div className="general-data-wrapper">
                                                    <div className="line">
                                                        ...
                                                        <div className="separator">
                                                            <span>Veículo:</span>
                                                            <div>
                                                                <select name="vehicleId" id="vehicleId" data-transport-id={transport._id}  value={transport.vehicleId} onChange={handleUpdateTrip}>
                                                            ...
                                                            transport.patients.map((patient, patientIndex) => (
                                                                <tr className="transport-row" key={patientIndex}>
                                                                    ...
                                                                    <td className="transport-actions">
                                                                        <button data-transport-id={transport._id} data-patient-index={patientIndex} onClick={handleDeletePatient}>
...

                                                        {
                                                            transport.patients.length < 4 ? (
                                                                <tr className="transport-row">
                                                                    ...
                                                                    <td className="transport-actions new">
                                            ...
                                            <div className="transport-controls-container">
                                                <button className="delete-transport" onClick={() => handleRemoveFixedTransport(transport._id)}>Excluir transporte</button>
                            ...
                            <div className="swipe-transport-controls end">
                                <button onClick={handleCreateTransport}>
                                    Adicionar Veículo
                                    ...
                                    <svg width="40" height="40" viewBox="0 0 67 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M38.0203 38.02L45.8007 38.022C46.9295 38.022 48.0121 37.5736 48.8103 36.7754C49.6085 35.9772 50.057 34.8946 50.057 33.7658C50.057 32.6369 49.6085 31.5543 48.8103 30.7561C48.0121 29.9579 46.9295 29.5095 45.8007 29.5095L38.0203 29.5115L38.0224 21.7311C38.0224 20.6023 37.5739 19.5197 36.7757 18.7215C35.9775 17.9233 34.8949 17.4749 33.7661 17.4749C32.6373 17.4749 31.5547 17.9233 30.7565 18.7215C29.9583 19.5197 29.5099 20.6023 29.5099 21.7311L29.5119 29.5115L21.7315 29.5095C20.6027 29.5095 19.5201 29.9579 18.7219 30.7561C17.9237 31.5543 17.4753 32.6369 17.4753 33.7658C17.4753 34.8946 17.9237 35.9772 18.7219 36.7754C19.5201 37.5736 20.6027 38.022 21.7315 38.022L29.5119 38.02L29.5099 45.8004C29.5099 46.9292 29.9583 48.0118 30.7565 48.81C31.5547 49.6082 32.6373 50.0566 33.7661 50.0566C34.8949 50.0566 35.9775 49.6082 36.7757 48.81C37.5739 48.0118 38.0224 46.9292 38.0224 45.8004L38.0203 38.02Z" fill="white"/>
                                    </svg>
