                        ...
                        <div className="menu-wrapper">
                            <a href="/transportes">
                                <svg width="16" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M17.7292 1.91667H17.25V1.4375C17.25 1.05625 17.0985 0.690617 16.829 0.421034C16.5594 0.15145 16.1937 0 15.8125 0C15.4313 0 15.0656 0.15145 14.796 0.421034C14.5264 0.690617 14.375 1.05625 14.375 1.4375V1.91667H8.625V1.4375C8.625 1.05625 8.47355 0.690617 8.20397 0.421034C7.93438 0.15145 7.56875 0 7.1875 0C6.80625 0 6.44062 0.15145 6.17103 0.421034C5.90145 0.690617 5.75 1.05625 5.75 1.4375V1.91667H5.27083C3.87292 1.91667 2.53226 2.47199 1.54379 3.46046C0.555318 4.44893 0 5.78959 0 7.1875V17.7292C0 19.1271 0.555318 20.4677 1.54379 21.4562C2.53226 22.4447 3.87292 23 5.27083 23H17.7292C19.1271 23 20.4677 22.4447 21.4562 21.4562C22.4447 20.4677 23 19.1271 23 17.7292V7.1875C23 5.78959 22.4447 4.44893 21.4562 3.46046C20.4677 2.47199 19.1271 1.91667 17.7292 1.91667ZM17.7292 20.125H5.27083C4.63542 20.125 4.02603 19.8726 3.57672 19.4233C3.12742 18.974 2.875 18.3646 2.875 17.7292V9.58333H20.125V17.7292C20.125 18.3646 19.8726 18.974 19.4233 19.4233C18.974 19.8726 18.3646 20.125 17.7292 20.125Z" fill="#333333"/>
                                </svg>
                                                            ...
                                                            transport.patients.map((patient, patientIndex) => (
                                                                <tr className="transport-row" key={patientIndex}>
                                                                    ...
                                                                    <td className="transport-actions">
                                                                        <button data-transport-id={transport._id} data-patient-index={patientIndex} onClick={handleDeletePatient}><img src={excludeIcon} alt="Excluir" /></button>
                                                                    </td>
                                                                </tr>
                                                            ))
                                                        }
